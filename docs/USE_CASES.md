# Use Cases — Tapkey Android Sample App

Each use case captures actors, class relationships, and interaction sequence to support the parent project's Phase 1 BLE architecture study.
...
All actors, use cases, and what each actor gains.
